...
val_result_csv = "predictions/ds1Val-dt.csv"
test_result_csv = "predictions/ds1Test-dt.csv"
model_name = "models/ds1-dt.joblib"
...
# create classifier
classifier = DecisionTreeClassifier("entropy", max_features=0.9)
