...
val_result_csv = "predictions/ds2Val-dt.csv"
test_result_csv = "predictions/ds2Test-dt.csv"
model_name = "models/ds2-dt.joblib"
...
# create classifier
classifier = DecisionTreeClassifier(max_leaf_nodes=300, max_depth=30)
