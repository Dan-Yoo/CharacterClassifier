...
val_result_csv = "predictions/ds2Val-nn.csv"
test_result_csv = "predictions/ds2Test-nn.csv"
model_name = "models/ds2-nn.joblib"
...
# create classifier
classifier = MLPClassifier(hidden_layer_sizes=(100, 100), max_iter=300, learning_rate_init=0.0015, tol=0.00001)
